...
Ребята, а кто делал домашку #5 по Java. У меня постоянно всплывает окно о предложении дать фидбек, или что-то подобное. Оно все блокирут, не дает нажать кнопку Submit.  Поймать я его в ручном режиме не могу. А при запуске автотеста - но появляется. Как вообще уйти от этих всплывающих окон? Я так понимаю надо какие-то параметры в опциях при открытии ChromeDriver указать. Или как?
