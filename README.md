...
ребят, старайтесь излагать ваши мысли, запросы и ответы в одном сообщении, не разбивая три слова на три сообщения, идущих одно за другим, лимит сообщений в slack никто не отменял, через месяц вы уже не найдёте того, что было написано в начале курса:spock-hand::skin-tone-2: